...
public class MapperGeneration implements StringGrammarBasedProblem<String, Pair<Tree<Element>, Tree<Element>>>, QualityBasedProblem<Pair<Tree<Element>, Tree<Element>>, List<Double>> {
