...
package it.units.malelab.core.representation.graph.numeric.functiongraph;

import it.units.malelab.core.IndependentFactory;
import it.units.malelab.core.representation.graph.Graph;
import it.units.malelab.core.representation.graph.LinkedHashGraph;
import it.units.malelab.core.representation.graph.Node;
import it.units.malelab.core.representation.graph.numeric.Constant;
