...
public class SymbolicRegressionComparison extends Worker {
  ...
  public void run() {
    ...
    List<SyntheticUnivariateRegressionProblem> problems =
        List.of(
    ...
    solvers.put(
        "tree-ga",
        p -> {
          IndependentFactory<Element> terminalFactory =
              IndependentFactory.oneOf(
                  IndependentFactory.picker(
                      p.qualityFunction().getDataset().xVarNames().stream()
          ...
          return new StandardEvolver<>(
              ...
              Map.of(
                  ...
                  new ArcAddition<IndexedNode<Node>, Double>(RandomGenerator::nextGaussian, false)
                      .withChecker(g -> checker.test(graphMapper.apply(g))),
                  graphArcAdditionRate,
                  new ArcRemoval<IndexedNode<Node>, Double>(
                  ...
                  new IndexedNodeAddition<FunctionNode, Node, Double>(
                          ...
                          n ->
                              (n instanceof FunctionNode)
                                  ? ((FunctionNode) n).getFunction().hashCode()
                                  : 0,
    ...
    solvers.put(
        "ograph-hash+-speciated",
        p -> {
          Function<
                  Graph<IndexedNode<Node>, OperatorGraph.NonValuedArc>,
                  Graph<Node, OperatorGraph.NonValuedArc>>
                  ...
                  new IndexedNodeAddition<OperatorNode, Node, OperatorGraph.NonValuedArc>(
                          ...
                          n ->
                              (n instanceof OperatorNode)
                                  ? ((OperatorNode) n).getOperator().hashCode()
                                  : 0,
