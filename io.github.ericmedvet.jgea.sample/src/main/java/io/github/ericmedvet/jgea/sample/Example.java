...
public class Example {
  /*
  public static final List<Function<State<Problem<Object>, Object>, ?>> PLAIN_STATE_FUNCTIONS =
  List.of();
  ...
  new TabularPrinter<>(
  Misc.concat(
  List.of(PLAIN_STATE_FUNCTIONS, BASIC_FUNCTIONS, DOUBLE_FUNCTIONS)),
  List.of( ));
  ...
  Misc.concat(
  List.of(PLAIN_STATE_FUNCTIONS, BASIC_FUNCTIONS, DOUBLE_FUNCTIONS)),
  List.of( (Map<String, Object> m) -> m.get("solver")));
  List<
  IterativeSolver<
