...
public class Predicates {
  ...
  public static <X> Predicate<X> all(
      @Param("conditions") List<Predicate<X>> conditions
  ) {
  ...
  @SuppressWarnings("unused")
  public static <X> Predicate<X> any(
      @Param("conditions") List<Predicate<X>> conditions
  ) {
  ...
  @SuppressWarnings("unused")
  public static <X, T> Predicate<X> in(
      @Param(value = "f", dNPM = "ea.nf.identity()") NamedFunction<X, T> function,
