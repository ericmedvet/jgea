  ...
  private static final NamedBuilder<Object> NB =
      NamedBuilder.empty()
          .and(
              ...
              NamedBuilder.empty()
                  .and(
                      List.of("randomGenerator", "rg"),
                      NamedBuilder.fromUtilityClass(RandomGenerators.class))
                  .and(
                      List.of("problem", "p"),
                      NamedBuilder.empty()
                          .and(NamedBuilder.fromUtilityClass(Problems.class))
                          .and(
                              List.of("univariateRegression", "ur"),
                              NamedBuilder.fromUtilityClass(UnivariateRegressionProblems.class))
                          .and(
                              List.of("multivariateRegression", "mr"),
                              NamedBuilder.fromUtilityClass(MultivariateRegressionProblems.class))
                          .and(
                              List.of("synthetic", "s"),
                              NamedBuilder.fromUtilityClass(SyntheticProblems.class)))
                  .and(
                      List.of("dataset", "d"),
                      NamedBuilder.empty()
                          .and(
                              List.of("numerical", "num"),
                              NamedBuilder.fromUtilityClass(NumericalDatasets.class)))
