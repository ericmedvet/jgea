...
public class Plots {
  ...
  public static <G, S, Q>
  XYDataSeriesPlotAccumulatorFactory<POCPopulationState<?, G, S, Q>, Run<?, G, S, Q>> dyPlot(
      @Param(
          value = "titleRunKey",
  ...
  @SuppressWarnings("unused")
  public static <G, S, Q>
  XYDataSeriesPlotAccumulatorFactory<POCPopulationState<?, G, S, Q>, Run<?, G, S, Q>> elapsed(
      @Param(
          value = "titleRunKey",
          dNPM = "ea.misc.sEntry(key=\"run.index\";value=\"run index = {index}\")")
      Map.Entry<String, String> titleRunKey,
  ...
  @SuppressWarnings("unused")
  public static <G, S, Q>
  XYDataSeriesPlotAccumulatorFactory<POCPopulationState<?, G, S, Q>, Run<?, G, S, Q>> fitness(
      @Param(
          value = "titleRunKey",
          dNPM = "ea.misc.sEntry(key=\"run.index\";value=\"run index = {index}\")")
      Map.Entry<String, String> titleRunKey,
  ...
  @SuppressWarnings("unused")
  public static <G, S, Q>
  XYDataSeriesPlotAccumulatorFactory<POCPopulationState<?, G, S, Q>, Run<?, G, S, Q>> yPlot(
      @Param(
          value = "titleRunKey",
          dNPM = "ea.misc.sEntry(key=\"run.index\";value=\"run index = {index}\")")
      Map.Entry<String, String> titleRunKey,
  ...
  @SuppressWarnings("unused")
  public static <G, S, Q>
  XYDataSeriesPlotAccumulatorFactory<POCPopulationState<?, G, S, Q>, Run<?, G, S, Q>> ysPlot(
      @Param(
          value = "titleRunKey",
          dNPM = "ea.misc.sEntry(key=\"run.index\";value=\"run index = {index}\")")
      Map.Entry<String, String> titleRunKey,
  ...
  @SuppressWarnings("unused")
  public static <G, S, Q> UnivariateGridPlotAccumulatorFactory<GridPopulationState<G, S, Q>, Individual<G, S, Q>,
      Long, Run<?, G, S, Q>> gridPopulation(
      @Param(
          value = "titleRunKey",
          dNPM = "ea.misc.sEntry(key=\"run.index\";value=\"run index = {index}\")")
      Map.Entry<String, String> titleRunKey,
      ...
      @Param(value = "iterations", dIs = {0, 10, 100}) List<Integer> iterations
  ) {
