...
public class Cabea<G, S, Q>
    extends AbstractPopulationBasedIterativeSolver<
        CabeaPopulationState<G, S, Q>, QualityBasedProblem<S, Q>, Individual<G, S, Q>, G, S, Q> {
  ...
  private record State<G, S, Q>(
      ...
      implements CabeaPopulationState<G, S, Q> {
    public static <G, S, Q> State<G, S, Q> from(
      ...
      return new State<>(
          ...
          mapOfGA.size(),
          mapOfGA.size(),
          PartiallyOrderedCollection.from(mapOfGA.values(), partialComparator),
          mapOfGA,
          descriptors);
    }
  ...
  public Cabea(
      ...
      Predicate<? super CabeaPopulationState<G, S, Q>> stopCondition,
      Mutation<G> mutation,
      int populationSize,
      List<Descriptor<G, S, Q>> descriptors) {
  ...
  protected Individual<G, S, Q> newIndividual(
          G genotype, CabeaPopulationState<G, S, Q> state, QualityBasedProblem<S, Q> problem) {
  ...
  protected Individual<G, S, Q> updateIndividual(
          Individual<G, S, Q> individual, CabeaPopulationState<G, S, Q> state, QualityBasedProblem<S, Q> problem) {
    return Individual.of(
        individual.genotype(),
        individual.solution(),
  ...
  private Map<List<Integer>, Individual<G, S, Q>> mapOfGA(
      Collection<Individual<G, S, Q>> individuals,  // I take the new individuals
      Map<List<Integer>, Individual<G, S, Q>> map,  // I take the old map
      PartialComparator<? super Individual<G, S, Q>> partialComparator) {  // I take an order
    ...
    // replace the bin with the individuals which are better
  }
  ...
  @Override
  public CabeaPopulationState<G, S, Q> init(
  ...
  @Override
  public CabeaPopulationState<G, S, Q> update(
      QualityBasedProblem<S, Q> problem,
      RandomGenerator random,
      ExecutorService executor,
      CabeaPopulationState<G, S, Q> state)
      throws SolverException {
    // build new genotypes
