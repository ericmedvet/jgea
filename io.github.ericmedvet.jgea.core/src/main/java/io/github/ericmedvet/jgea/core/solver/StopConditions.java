...
public class StopConditions {
  ...
  @SuppressWarnings("unused")
  public static ProgressBasedStopCondition<POSetPopulationState<?, ?, ?>> nOfFitnessEvaluations(
      final long n) {
  ...
  public static <F extends Comparable<F>>
      Predicate<POSetPopulationState<?, ?, ? extends F>> targetFitness(final F targetF) {
    return s ->
